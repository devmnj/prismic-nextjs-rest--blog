    ...
    <div className="flex justify-center mt-6 lg:flex lg:mt-0 lg:-mx-2">
      ...
      >
        <svg
          ...
          viewBox="0 0 512 512"
          className="w-7 h-7 hover:text-orange-500 text-slate-800"
        >
          <path
            fill="currentColor"
      ...
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          className="w-7 h-7  hover:text-yellow-500 text-slate-800"
        >
          {" "}
          <path
            fill="currentColor"
      ...
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          className="w-7 h-7  hover:text-blue-500 text-slate-800"
        >
          {" "}
          <path
            fill="currentColor"
      ...
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 496 512"
          className="w-7 h-7 hover:text-green-800 text-slate-800"
        >
          {" "}
          <path
            fill="currentColor"
